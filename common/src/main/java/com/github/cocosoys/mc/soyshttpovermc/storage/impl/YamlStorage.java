...
public class YamlStorage implements DataStorage {
    ...
    public YamlStorage(Platform platform) {
     ...
     * </ul>
     */
    public static File resolveDir(Platform platform, String fileCfg) {
    ...
    public void initialize() throws Exception {
        ConfigSection section = platform.getConfig().getSection("storage.backends.yaml");
        ...
        File dir = resolveDir(platform, fileCfg);
        ...
        try {
            this.config = platform.loadYaml(file);
            if (!config.isSection(ROOT)) {
    ...
    public SyncRecord load(String key) throws Exception {
        ...
        try {
            ConfigSection section = config.getSection(ROOT + "." + key);
    ...
    private SyncRecord deserialize(String key, ConfigSection section) {
