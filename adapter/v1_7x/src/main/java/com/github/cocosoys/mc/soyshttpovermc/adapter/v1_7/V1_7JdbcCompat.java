...
/**
 * 1.7.x 专用 JDBC 兼容：为服务端自带的 JDBC3 旧驱动补上
 ...
 *
 * <p>本实现只在本模块（v1_7x）内自持，不进入 core/common；
 * 与 v1_6x / v1_6xJava7 不共享（各版本自行实现）。</p>
 */
final class V1_7JdbcCompat {

    private V1_7JdbcCompat() {
    }
