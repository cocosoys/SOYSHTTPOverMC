...
public abstract class AbstractConfigSource {
    ...
    protected final String dataRelative;    // 数据目录下的相对路径，如 thismyhomepages/home.yml
    protected final String defaultResource;  // jar 内默认模板资源路径，如 thismyhomepages/home.yml
