 ...
 * <b>初始化</b>由 {@link ConfigManager#initPagesConfig} 统一书写，最终在 {@link soys.soyshttpovermc.HttpOverMcPlugin} 装配调用。</p>
 */
@CustomLog
public final class PagesConfig {
     ...
     */
    public void setWebHome(JavaPlugin plugin, String value) {
        if (cfg == null) {
            PagesConfig c = load(plugin);
            if (c.cfg == null) return;
            this.cfg = c.cfg;
        }
