package soys.soyshttpovermc.api.spring.service;

import soys.soyshttpovermc.api.spring.entity.BaseEntity;
 ...
 * 通用默认实现由 {@link soys.soyshttpovermc.api.spring.impl.BaseServiceImpl} 提供，
