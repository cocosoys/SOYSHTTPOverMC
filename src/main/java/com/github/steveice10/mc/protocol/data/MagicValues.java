...
public class MagicValues {
    ...
    static {
        ...
        // Spigot/CraftBukkit 玩家实体额外注册的触达距离属性（原版协议无；MCProtocolLib 枚举缺失会致
        // ServerEntityPropertiesPacket 解码抛 IllegalArgumentException → Bot 断连，故补注册）
        register(AttributeType.GENERIC_REACH_DISTANCE, "generic.reachDistance");
